        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12  py-2">
                    <h5 class="text-uppercase">Về AIO</h5>

                    <ul class="list-unstyled mb-0">
                        <li>
                            <a href="" class="text-white">Giới thiệu AIO
                            </a>
                        </li>
                        <li>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12  py-2">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <a href="#!" class="text-white">Mua gọi: </a>
                            <strong>0123.4567 (08:30 – 21:30)</strong>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h5>WEBSITE UY TIN CHẤT LƯỢNG </h5>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"
                                ...
                                <g clip-path="url(#clipm)">
                                    ...
                                    <path
                                        ...
                                        fill="#9C8350"></path>
                                    <path
                                        d="M14.163 6.13556C13.0228 6.90724 12.0538 7.57157 11.2558 8.1289L15 11.8733V5.40723C14.7599 5.67523 14.481 5.91788 14.163 6.13556Z"
                                        fill="#9C8350"></path>
                                    <path
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-text" style="background-color:pink"><a
                                style="text-decoration: none;color: rgb(217, 58, 58)" href="register.php">Đăng ký</a>
                    </div>
                    <span style="text-decoration: none;color:#dc3545;font-size:20px">
