              ...
              <div id="nd-login">
                <form action="<?= $linkBE . 'login_process.php' ?>" method="post" id="customer_login"
                  ...
                  <p class="text-right recover">
                    <a href="#" class="btn-link-style" onclick="showRecoverPasswordForm();" title="Quên mật khẩu?">Quên
                      mật khẩu?</a>
                  </p>
              ...
              <div id="recover-password" class="form-signup" style="display:none;">
                ...
                <form method="post" action="/account/recover" id="recover_customer_password" accept-charset="UTF-8"
                  ...
                  <fieldset class="form-group">
                    ...
                    <input id="recover_account" placeholder="Nhập tài khoản" type="text" class="form-control"
